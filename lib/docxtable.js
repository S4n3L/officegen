module.exports = {
  ...
  _getColSpecs: function(cols, opts) {
    var self = this;
    return opts.colSpecs.map(function(val, idx) {
      return self._tblGrid(opts.colSpecs[idx]);
    });
  },
      ...
      function parseParagraphContent (paragraph) {
        ...
        function makeParagraphObject(paragraphOptions, contentsList) {
          var paragraphObj = {
            ...
            "w:ilvl": {"@w:val": 0},
            "w:numId": {"@w:val": paragraphOptions.list_type}
            };
          }
          return paragraphObj;
        }
